...
import { formatPercent, formatTimecode } from "../utils/format";
		...
		<footer class="transport-bar">
			<div class="transport-control-cluster">
				<div class="transport-buttons">
					<IconButton
						label="Restart"
						shortcut={KEYBOARD_SHORTCUT_HINTS.restart}
					...
					<IconButton
						label="Stop"
						shortcut={KEYBOARD_SHORTCUT_HINTS.stop}
						disabled={!props.canPlay}
			...
			<div class="transport-time">
				<Timer />
				<span>
					{formatTimecode(props.playback.positionMs)} / {formatTimecode(props.playback.durationMs)}
				</span>
				<div class="transport-time__shortcuts" aria-hidden="true">
					<span>
						<ShortcutKeycap hint={KEYBOARD_SHORTCUT_HINTS.nudgePlayback} /> Nudge
					</span>
					<span>
						<ShortcutKeycap hint={KEYBOARD_SHORTCUT_HINTS.focusLane} /> Lane
					</span>
				</div>
			</div>
			...
			<div class="mode-toggles" aria-label="Playback modes">
				...
				<button
					classList={{
						"is-active": props.controls.metronomeEnabled,
						"is-metronome-active": props.controls.metronomeEnabled,
					}}
				...
				>
					<span
						class="metronome-toggle__icon"
						classList={{
							"is-tick-left":
								props.controls.metronomeEnabled && props.metronomeTick > 0 && props.metronomeTick % 2 === 0,
							"is-tick-right": props.controls.metronomeEnabled && props.metronomeTick % 2 === 1,
						}}
						aria-hidden="true"
					>
						<Metronome />
